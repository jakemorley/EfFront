...
class SecuritiesControllerTest < ActionController::TestCase
  ...
  test "should create security" do
    assert_difference('Security.count') do
      post :create, security: { bookprice: @security.bookprice, marketprice: @security.marketprice, name: @security.name, sigma: @security.sigma }
    end
  ...
  test "should update security" do
    patch :update, id: @security, security: { bookprice: @security.bookprice, marketprice: @security.marketprice, name: @security.name, sigma: @security.sigma }
    assert_redirected_to security_path(assigns(:security))
  end
